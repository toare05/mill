  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:bg-blue-600 data-[state=active]:text-white data-[state=active]:font-medium data-[state=inactive]:bg-gray-100 data-[state=inactive]:text-gray-700",
        className
      )}
      {...props}
    />
